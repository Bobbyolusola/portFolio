        ...
        <div className="works" id="works">
            <div className="divider">
                <div className="skills1">
                    <div className="top">
                        <img src="https://www.pngkit.com/png/full/37-379755_web-development-website-development-images-hd.png" alt=""
                        />
                    </div>
                    <div className="below">
                ...
                <div className="skills2">
                    <div className="top">
                        ...
                        <img src="https://img.freepik.com/free-vector/ux-ui-typographic-header-app-interface-improvement-user-interface-design-and-user-experience-development-modern-technology-concept-flat-vector-illustration_613284-1484.jpg?w=2000" alt=""/>
                    </div>
                    <div className="below">
